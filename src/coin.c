...
void spawn_coin(uint8_t x, uint8_t y) {
...
bool cursor_over_coin(Coin* coin) {
    ...
    // Use the ABS macro from utils.h to check if the centers are within 8 pixels of each other
